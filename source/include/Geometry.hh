...
//------------------------------------------------------------------------------
{
  public:
   ...
   ~Geometry();
	...
	G4LogicalVolume* ConstructShashlikTower();
	//Passive volumes
	...
	//Leakage "detector"
    G4LogicalVolume* GetScoringVol_Gap1() const { return fScoringVol_Gap1; }
    G4LogicalVolume* GetScoringVol_Gap2() const { return fScoringVol_Gap2; }
  ...
  protected:
    ...
    G4LogicalVolume*  fScoringVol_Gap1;
    G4LogicalVolume*  fScoringVol_Gap2;
};
#endif
